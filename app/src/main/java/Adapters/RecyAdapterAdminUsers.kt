...
import Controllers.CreateAccountEmail_Controller
...
//            context.startActivity(intent)
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val mailUser = view.findViewById(R.id.txtEmail) as TextView
        val userPicture = view.findViewById(R.id.UserPicture) as ImageView
